...
MSG_TASK1 = '{"msg_id": null, "payload": {"task_id": "e5bfcc21-de44-47d9-9189-1f9f9145331f", "title": "Test data 1", "x": [[1, 2], [3, 4], [5, 6]]}, "reply_id": null, "type": "task"}'
...
def test_message_task():
    ...
    label_name = ['Y', 'N']
    with fake_uuid():
        t = dto.Message(const_msg.TYPE_TASK, dto.Data(dto.get_id(), X, "Test data 1"))
